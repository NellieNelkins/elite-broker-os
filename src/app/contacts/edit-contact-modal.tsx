...
export function EditContactModal({ open, contact, onClose, onSaved }: EditContactModalProps) {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(data.error || `Failed to update contact (${res.status})`);
      }
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-lg font-semibold text-[var(--text-gold)]">Edit Contact</h2>
